...
datos = [
    [3, 0.7, 85, 36.8, 0.05], [2, 0.5, 80, 36.7, 0.04], [4, 0.9, 90, 36.9, 0.06],
    [1, 0.3, 75, 36.5, 0.03], [0, 0.1, 70, 36.4, 0.02], [3, 0.6, 85, 36.8, 0.04],
    [2, 0.5, 78, 36.6, 0.03], [1, 0.4, 76, 36.5, 0.02], [4, 0.8, 88, 36.7, 0.05],
    [2, 0.5, 82, 36.6, 0.04]
]
